...
function formatProviderCountSummary(summary) {
  ...
  return [
    ...
    `providerGuardCountSource:${String(countSummary?.providerGuardCountSource ?? lifecycle?.providerGuardCountSource ?? summary?.providerGuardCountSource ?? 'none').slice(0, 80)}`,
    `providerGuardUsesRefreshedPanelState:${Boolean(summary?.providerGuardUsesRefreshedPanelState ?? summary?.providerPhaseGuardState?.providerGuardUsesRefreshedPanelState)}`,
...
function formatProviderDiagnosticsExportSummary(summary) {
  ...
  return [
    ...
    `providerGuardCountSource:${String(summary?.providerGuardCountSource ?? guardState?.providerGuardCountSource ?? 'none').slice(0, 80)}`,
    `providerGuardUsesRefreshedPanelState:${Boolean(summary?.providerGuardUsesRefreshedPanelState ?? guardState?.providerGuardUsesRefreshedPanelState)}`,
    ...
    `providerLabelCoordinateLastError:${String(summary?.providerLabelCoordinateLastError?.message || 'none').slice(0, 120)}`,
...
function formatProviderCountLifecycle(summary) {
  ...
  return [
    ...
    `providerGuardCountSource:${String(lifecycle?.providerGuardCountSource || 'none').slice(0, 80)}`,
...
function formatFundingChoicesControls(summary) {
  ...
  lines.push(
    [
      ...
      `providerGuardCountSource: ${String(summary.providerGuardCountSource ?? providerPhaseGuardState?.providerGuardCountSource ?? 'none').slice(0, 80)}`,
      `providerGuardUsesRefreshedPanelState: ${Boolean(summary.providerGuardUsesRefreshedPanelState ?? providerPhaseGuardState?.providerGuardUsesRefreshedPanelState)}`,
